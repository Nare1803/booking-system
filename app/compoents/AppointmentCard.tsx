...
//   return (
//     <div
//       className={`bg-white rounded-2xl border border-slate-200 p-5 flex gap-4 ${appointment.status === "CANCELLED" ? "opacity-50" : ""}`}
//     >
//       {/* Date block */}
...
export function AppointmentCard({
  ...
  // Only doctors can mark as complete, only on PENDING or CONFIRMED
  const canComplete =
    role === "DOCTOR" &&
    (appointment.status === "PENDING" || appointment.status === "CONFIRMED");
